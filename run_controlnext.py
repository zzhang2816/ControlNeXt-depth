...
def read_video_frames(video_path, sample_stride):
    import decord
    # read input video
...
if __name__ == "__main__":
    ...
    validation_control_images = read_video_frames(args.validation_control_video_path, sample_stride=args.sample_stride)
